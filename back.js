...
require("./routes/auth")(app); // GET { check-session }
require("./routes/models")(app, sessions_map, get_database); // GET { check-session }
require("./routes/planning")(app, sessions_map, get_database); // GET { check-session }
